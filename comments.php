...
<?php if ( have_comments() ) : ?>
	...
	<h3 id="comments" class="subheader"><?php comments_number('<span>No</span> Responses', '<span>One</span> Response', '<span>%</span> Responses' );?> to &#8220;<?php the_title(); ?>&#8221;</h3>
	...
	<?php
		//TODO: Decide if we want to add this options panel to our backend like 320Press
		$suppress_comments_message = 'NAH BRAH';//of_get_option('suppress_comments_message');
